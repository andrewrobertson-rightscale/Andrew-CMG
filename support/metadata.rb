...
recipe "cmg_oo::vhost_xenforo-addons_carbonmedia_net", "Sets up the www.xenforo-addons_carbonmedia.net vhost(s) and alias(es) (if applicable)."recipe "cmg_oo::vhost_ohiogamefishing_com", "Sets up the www.ohiogamefishing.com vhost(s) and alias(es) (if applicable)."
